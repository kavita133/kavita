      ...
      <div class="container">
        <nav class="navbar">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">mOHIT AGENCY</a>
          </div>
      ...
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            <h2 class="page-section__title">ABOUT CREATIVE AGENCY</h2>
            ...
            <div class="row gutters-100">
              <div class="col-md-4 col-lg-3">
                <div class="footer__first">
                  <h2 class="footer__title">CREATIVE AGENCY</h2>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="footer__third">
                  ...
                  <ul>
                    <li><span class="glyphicon glyphicon-envelope"></span> <a href="#">creativeagency@gmail.com</a></li>
